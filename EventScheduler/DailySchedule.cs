...
// Type: MuhammedYuksel.EventScheduler.DailySchedule
...
namespace MuhammedYuksel.EventScheduler
{
  ...
  {
    public DailySchedule(string name, DateTime startTime, GunlukKur gKur)
      : base(name, startTime, ScheduleType.GUNLUK, gKur)
    {
    }
